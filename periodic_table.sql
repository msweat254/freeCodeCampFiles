...
INSERT INTO public.types VALUES (1, 'metalloid');
...
--
-- Name: elements elem_unique; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT elem_unique UNIQUE (symbol, name);
...
--
-- Name: properties an_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT an_fk FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
